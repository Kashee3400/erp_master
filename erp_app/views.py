...
class MemberByPhoneNumberView(generics.RetrieveAPIView):
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        response_data['mcc_code'] = mpp_aggregations.mcc_code
        response_data['mcc_name'] = mpp_aggregations.mcc_name
        response_data['mcc_tr_code'] = mpp_aggregations.mcc_tr_code

        response_data['mpp_name'] = mpp_aggregations.mpp_name
        response_data['mpp_code'] = mpp_aggregations.mpp_code
