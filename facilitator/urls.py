...
router.register(r'member-attendances', api_view.VCGMemberAttendanceViewSet,basename="member-attendances")
...
router.register(r'upload-meeting-images', api_view.VCGMeetingImagesViewSet,basename="upload-meeting-images")
