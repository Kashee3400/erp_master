...
router.register(
    r"sahayak-incentives", SahayakIncentivesViewSet, basename="sahayak-incentives"
)
...
urlpatterns = [
    ...
    path(
        "api/otp/sahayak/generate/",
        GenerateSahayakOTPView.as_view(),
        name="generate-sahayak-otp",
    ),
    path(
        "api/otp/sahayak/verify/",
        VerifySahayakOTPView.as_view(),
        name="verify-sahayak-otp",
    ),
    path("api/verify/session/", VerifySession.as_view(), name="verify-session"),
    path(
        "api/members/phone/", MemberByPhoneNumberView.as_view(), name="member-by-phone"
    ),
    path("api/member-profile/", MemberProfileView.as_view(), name="member-profile"),
    path(
        "api/members/billing-history/",
        BillingMemberDetailView.as_view(),
        name="member-billing-history",
    ),
    path(
        "api/new-mpp-collection/",
        MppCollectionListView.as_view(),
        name="new-mpp-collection-list",
    ),
    path(
        "api/mpp-collection-detail/",
    ...
    path(
        ...
        NewsNotReadCountAPIView.as_view(),
        name="news-not-read-count",
    ),
    path(
        "api/sahayak-dashboard-data/",
        NewSahayakDashboardAPI.as_view(),
        name="sahayak-dashboard-data",
    ),
    path(
        "api/app-installed-data/", AppInstalledData.as_view(), name="app-installed-data"
    ),
    path(
