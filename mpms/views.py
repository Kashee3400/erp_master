...
class OldDataCollectionView(generics.GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if fy_start_date <= today <= fy_end_date or fy_start_date <= provided_date <= fy_end_date:
            ...
            unique_dumpdate_count = mpms_farmer_collection.values('dumpdate').distinct().count()
