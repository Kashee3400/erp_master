...
#     help = "Create default cost configurations based on pricing table"

#     def handle(self, *args, **options):
#         default_configs = [
#             # Member - Before 10:00 AM
#             {'membership_type': 'member', 'time_slot': 'before_10am', 'animal_tag_type': 'tagged',
#              'treatment_type': 'normal', 'cost_amount': 300},
#             {'membership_type': 'member', 'time_slot': 'before_10am', 'animal_tag_type': 'non_tagged',
#              'treatment_type': 'normal', 'cost_amount': 400},
#             {'membership_type': 'member', 'time_slot': 'before_10am', 'animal_tag_type': 'tagged',
#              'treatment_type': 'emergency', 'cost_amount': 1200},
#             {'membership_type': 'member', 'time_slot': 'before_10am', 'animal_tag_type': 'non_tagged',
#              'treatment_type': 'emergency', 'cost_amount': 800},

#             # Member - After 10:00 AM
#             {'membership_type': 'member', 'time_slot': 'after_10am', 'animal_tag_type': 'tagged',
#              'treatment_type': 'normal', 'cost_amount': 500},
#             {'membership_type': 'member', 'time_slot': 'after_10am', 'animal_tag_type': 'non_tagged',
#              'treatment_type': 'normal', 'cost_amount': 600},
#             {'membership_type': 'member', 'time_slot': 'after_10am', 'animal_tag_type': 'tagged',
#              'treatment_type': 'emergency', 'cost_amount': 1500},
#             {'membership_type': 'member', 'time_slot': 'after_10am', 'animal_tag_type': 'non_tagged',
#              'treatment_type': 'emergency', 'cost_amount': 1000},

#             # Non-Member - Before 10:00 AM
#             {'membership_type': 'non_member', 'time_slot': 'before_10am', 'animal_tag_type': 'tagged',
#              'treatment_type': 'normal', 'cost_amount': 500},
#             {'membership_type': 'non_member', 'time_slot': 'before_10am', 'animal_tag_type': 'non_tagged',
#              'treatment_type': 'normal', 'cost_amount': 600},
#             {'membership_type': 'non_member', 'time_slot': 'before_10am', 'animal_tag_type': 'tagged',
#              'treatment_type': 'emergency', 'cost_amount': 1500},
#             {'membership_type': 'non_member', 'time_slot': 'before_10am', 'animal_tag_type': 'non_tagged',
...
#             {'membership_type': 'non_member', 'time_slot': 'after_10am', 'animal_tag_type': 'tagged',
#              'treatment_type': 'normal', 'cost_amount': 600},
#             {'membership_type': 'non_member', 'time_slot': 'after_10am', 'animal_tag_type': 'non_tagged',
#              'treatment_type': 'normal', 'cost_amount': 700},
#             {'membership_type': 'non_member', 'time_slot': 'after_10am', 'animal_tag_type': 'tagged',
#              'treatment_type': 'emergency', 'cost_amount': 2000},
#             {'membership_type': 'non_member', 'time_slot': 'after_10am', 'animal_tag_type': 'non_tagged',
#              'treatment_type': 'emergency', 'cost_amount': 1200},
#         ]
...
#         self.stdout.write(
#             self.style.SUCCESS(f"Default cost configurations setup complete. {created_count} new entries created."))
